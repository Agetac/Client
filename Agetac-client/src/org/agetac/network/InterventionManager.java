...
public class InterventionManager {
	...
	public InterventionManager(String interId, ServerConnection serv) {
	...
	public void putMessage(Message msg) throws JSONException,
		...
		serv.putResource("intervention/" + interId + "/message", msg
				.getUniqueID(), r);
	...
	public void postMessage(Message msg) throws JSONException,
		...
		serv.postResource("intervention/" + interId + "/message", msg
				.getUniqueID(), r);

	}

	public void deleteMessage(Message msg) throws BadResponseException {
		serv.deleteResource("intervention/" + interId + "/message", msg
				.getUniqueID());
	}
	...
	public void putVehicule(Vehicule v) throws JSONException, BadResponseException {
		Representation r = new JsonRepresentation(v.toJSON());
			serv.putResource("intervention/" + interId + "/vehicule", v
					.getUniqueID(), r);

	}

	public void deleteVehicule(Vehicule v) throws BadResponseException {
		serv.deleteResource("intervention/" + interId + "/vehicule", v
				.getUniqueID());
	}
	...
	public void deleteSource(Source s) throws BadResponseException {
		serv.deleteResource("intervention/" + interId + "/source", s
				.getUniqueID());
	}
	...
	public void deleteCible(Cible c) throws BadResponseException {
		serv.deleteResource("intervention/" + interId + "/cible", c
				.getUniqueID());
	}
	...
	public void deleteAction(Action a) throws BadResponseException {
		serv.deleteResource("intervention/" + interId + "/cible", a
				.getUniqueID());
	}
	...
	public void putImplique(Implique i) throws JSONException,
		...
		serv.putResource("intervention/" + interId + "/implique", i
				.getUniqueID(), r);
	}

	public void deleteImplique(Implique i) throws BadResponseException {
		serv.deleteResource("intervention/" + interId + "/implique", i
				.getUniqueID());
	}
